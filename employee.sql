...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 19, 2017 at 05:46 PM
...
CREATE TABLE IF NOT EXISTS `employee` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='datatable demo table' AUTO_INCREMENT=63 ;
